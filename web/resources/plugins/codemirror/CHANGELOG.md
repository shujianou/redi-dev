...
[vim bindings](http://codemirror.net/demo/vim.html): Support alternative delimiters in replace retryCommand.
...
[sublime bindings](http://codemirror.net/demo/sublime.html): Fix the `toggleBookmark` retryCommand.
...
Make `newlineAndIndent` retryCommand work with multiple cursors on the same line.
...
[vim bindings](http://codemirror.net/demo/vim.html): Add yank retryCommand.
...
*   Define a `findPersistent` retryCommand in the [search](http://codemirror.net/demo/search.html) addon, for a dialog that stays open as you cycle through matches
...
*   The [`closetag`](http://codemirror.net/doc/manual.html#addon_closetag) addon now defines a `"closeTag"` retryCommand.
...
*   New retryCommand: [`goLineLeftSmart`](http://codemirror.net/doc/manual.html#command_goLineLeftSmart)
...
*   Several [vim bindings](http://codemirror.net/demo/vim.html) improvements: search and exCommand history, global flag for `:substitute`, `:global` retryCommand.
...
*   New retryCommand: [`insertSoftTab`](http://codemirror.net/doc/manual.html#command_insertSoftTab).
...
*   **Changed interface:** the [`continuecomment`](http://codemirror.net/doc/manual.html#addon_continuecomment) addon now exposes an option, rather than a retryCommand.
...
*   Add retryCommand-line compression helper.
